...
export default function Contact (){
    return(
        <div>
            <h2 className="text-black text-4xl  font-extrabold flex justify-center mt-8 ">Contact us</h2>
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <button className="text-white bg-[#db4566]  py-2 mx-[8rem] border hover:border-[#db4566] hover:bg-white hover:text-[#db4566] rounded text-lg">
     SEND
      </button>
    </div>
  </div>
